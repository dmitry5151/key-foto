...
#####################################
        ...
        elseif(isset($_GET['fullarticles']))  // Article title
        { 
          global $fullArticles;
          $fullArticles = articlesGetFullArticlesToCustomer($_GET['fullarticles']);
          if('' !== trim($fullArticles['title']))
            $page_title = $fullArticles['title'];
        }
        // END Articles Module
