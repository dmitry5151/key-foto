                ...
                else
                {
                        ...
                        if ($a) //product found
                        {
                                ...
                                if ($cnt[0] > 0)
                                {
                                        ...
                                        $addCols = function_exists('fu_make_url') ? ', p.uri, p.uri_opt_val, p.categoryID' : '';

                                        $p = db_query("SELECT p.productID, p.name, p.Price, pp.filename, pp.thumbnail, pp.enlarged $addCols
