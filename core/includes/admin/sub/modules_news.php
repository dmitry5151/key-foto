        ...
        if ( CONF_BACKEND_SAFEMODE != 1 && (!isset($_SESSION["log"]) || !in_array(18,$relaccess))) //unauthorized
        {
                ...
                if ( isset($_POST["news_save"]) )
                {
                        ...
                        $NID = newsAddNews($_POST["add_date"], $_POST["title"], $_POST["textToPrePublication"],
                                        $_POST["textToPublication"], $_POST["textToMail"], $_POST["slug"] );
                ...
                if ( isset($_POST["update_news"]) )
                {
                        ...
                        // BEGIN Human friendly URL's
                        newsUpdateNews($_POST["add_date"], $_POST["title"], $_POST["textToPrePublication"], $_POST["textToPublication"], $_POST["textToMail"], $_POST["edit_news_id"], $_POST["slug"] );
                        // END Human friendly URL's
                        if ( isset($_POST["send"]) ) //send news to subscribers
