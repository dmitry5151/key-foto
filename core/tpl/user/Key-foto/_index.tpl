{* главный файл-каркас шаблона магазина *}
...
<table cellspacing="0" cellpadding="0" width="100%" class="print">
  <tr>
    <td class="headlink bf" align="left"><a href="{$smarty.const.CONF_FULL_SHOP_URL}">Главная</a>
    <span class="delm">|</span><a href="{if $smarty.const.CONF_MOD_REWRITE eq 1}news.html{else}index.php?news=yes{/if}">Новости</a>
    ...
    <span class="delm">|</span><a href="{1|@fu_make_url_pages}">О магазине</a>
    <span class="delm">|</span><a href="index.php?links_exchange=yes">Cсылки</a>
    <span class="delm">|</span><a href="{if $smarty.const.CONF_OPEN_SHOPPING_CART_IN_NEW_WINDOW eq 1}javascript:open_window('index.php?do=cart',500,300);{else}{if $smarty.const.CONF_MOD_REWRITE eq 1}cart.html{else}index.php?shopping_cart=yes{/if}{/if}">Корзина</a>
    <span class="delm">|</span><a href="{if $smarty.const.CONF_MOD_REWRITE eq 1}feedback.html{else}index.php?feedback=yes{/if}">Контакты</a></td>
  </tr>
</table>
...
<table cellspacing="0" cellpadding="0" width="100%" class="print">
 <tr>
  <td>
    ...
    <table cellspacing="0" cellpadding="0" width="100%"><tr><td class="btbl">© 2009 Интернет-магазин</td></tr></table>
  </td>
 </tr>
</table>
