        ...
        <div class="dwa-content-layout">
            <div class="dwa-content-layout-row">
                <div class="dwa-layout-cell" style="width: 100%" >
                    <h3>{$smarty.const.STRING_REQUIRED}</h3>
                    <div class="fil2"></div>
                                        ...
                                        {if $countries}
                                            <tr>
                                                ...
                                                <td valign="middle" align="left">
                                                    <select name="countryID" onchange='billingAddressCheckHandler();
                                    ...
                                    {if $smarty.const.CONF_ENABLE_CONFIRMATION_CODE eq 1}
                                        ...
                                        <tr>
                                            ...
                                            {literal}{{/literal}
                                                        ...
                                                        this.value = '{$smarty.const.STR_ENTER_CCODE}'{literal}
                                                    }{/literal}"></td>
                                </tr>
                                <tr>
                                    <td colspan="2" style="height: 6px;"></td>
                            ...
                            <tr>
                                <td></td>
                                <td align="left" valign="middle"><a class="dwa-button" href="#" onclick="document.getElementById('RegisterForm').submit();
                                                return false">{$smarty.const.OK_BUTTON3}</a>&nbsp;&nbsp;<a class="dwa-button" href="#" onclick="document.getElementById('RegisterForm').reset();
                                                return false">{$smarty.const.RESET_BUTTON}</a>
