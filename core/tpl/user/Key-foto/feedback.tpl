        ...
        <div class="dwa-content-layout">
            <div class="dwa-content-layout-row">
                <div class="dwa-layout-cell" style="width: 100%">
                    <h2>{$smarty.const.STRING_FEEDBACK_DESCRIPTION}</h2>
                    {if $sent eq NULL}
                ...
                {literal}{{/literal}this.style.color='#aaaaaa';this.value='{$smarty.const.STR_ENTER_CCODE}'{literal}}{/literal}"></td>
                    ...
                    <table cellspacing="0" cellpadding="0" width="100%">
                        <tr>
                            <td class="hdbot" align="left"><a class="dwa-button" href="#" onclick="document.getElementById('formfeedback').submit(); return false">{$smarty.const.OK_BUTTON3}</a>&nbsp;<a class="dwa-button" href="#" onclick="document.getElementById('formfeedback').reset(); return false">{$smarty.const.RESET_BUTTON}</a></td>
                        </tr>
                    </table>
                    {else}
                    <table cellspacing="0" cellpadding="0" width="100%">
