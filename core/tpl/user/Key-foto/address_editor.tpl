                                                        ...
                                                        {else}
                                                            ...
                                                            {/if}
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td align="left" valign="top"><br><a class="dwa-button" href="#" onclick="document.getElementById('save').name = 'save';
                          document.getElementById('AddressForm').submit();
                          return false">{$smarty.const.SAVE_BUTTON}</a><input type="hidden" id="save" name='none' value='save'></td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                    </tr>
