<script src="data/{$smarty.const.TPL}/js/masonry.pkgd.min.js"></script>
{literal}
<script>
...
{section name=u loop=$products_to_show}
    <div class="frame_grid8">
        {include file="product_brief-grid8.tpl" product_info=$products_to_show[u]}
    </div>
{/section}
