...
<article class="dwa-post dwa-article">
    <h1 class="dwa-postheader">{$smarty.const.STRING_SHOPPING_HISTORY}</h1>
            ...
            <td><table cellspacing="0" cellpadding="0">
                ...
                <tr>
                  ...
                  //-->
					...
					{/if}                    
                    <br><a class="dwa-button" href="#" onclick="document.getElementById('MainForm').submit(); return false">{$smarty.const.OK_BUTTON3}</a>
...
<table cellspacing="0" cellpadding="0" width="100%">
  <tr>
    <td class="hmin">
      ...
      {/if}
      <table cellspacing="1" cellpadding="0" class="zebra" width="100%">
        <tr>
      ...
      <table cellspacing="0" cellpadding="0" width="100%" class="zebra">
        <tr>
          <td align="center">{$smarty.const.STRING_NO_ORDERS}</td>
        </tr>
      </table>
      {/if}
	</td>
...
{else}
<div class="fil1"></div>
<h3>{$smarty.const.STRING_ORDERING_INFO} #{$order.orderID}</h3>
  <div class="fil2"></div>
<form action="" name='MainForm' method="POST">
  ...
  <h3>{$smarty.const.ADMIN_ORDERED_PRODUCTS}</h3>
        ...
        <table cellspacing="1" cellpadding="0" width="100%" class="zebra">
          <tr>
            <th style="text-align: left" valign="middle" width="80%">{$smarty.const.ADMIN_TIME}</th>
            <th style="text-align: left" valign="middle">{$smarty.const.ADMIN_ORDER_STATUS_NAME}</th>
          </tr>
