...
<td class="tblimg"><a href="{$product_info|@fu_make_url}"><img src="data/small/{$product_info.picture}" alt="{$product_info.name}" width="50"></a></td>
{else}
...
<td class="center"><!-- Производительность -->
