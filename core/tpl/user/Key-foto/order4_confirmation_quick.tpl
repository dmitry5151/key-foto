{* шаблон сводной информации о заказе (последний шаг при оформлении) (без регистрации покупателя в магазине) *}

<article class="dwa-post dwa-article">
    <h1 class="dwa-postheader">{$smarty.const.STRING_ORDERING}</h1>
...
<table cellspacing="0" cellpadding="0" width="100%">
  <tr>
    <td class="cbt" align="left"><h5>{$smarty.const.STRING_ORDER_CONFIRMATION}</h5></td>
  </tr>
</table>
{if $order_success}
<div class="fil2"></div>
<table cellspacing="0" cellpadding="0" width="100%" class="zebra">
  <tr>
    <td align="center">{if $smarty.const.CONF_ACTIVE_ORDER eq 1}
...
<table cellspacing="0" cellpadding="0" width="100%">
  <tr>
    <td class="hdbot"><a class="dwa-button" href="#" onclick="document.getElementById('MainForm').submit(); return false;">{$smarty.const.STRING_FORMALIZE_ORDER}</a></td>
  </tr>
</table>
{/if}
{/if}
