{* шаблон сводной информации о заказе (последний шаг при оформлении) (с регистрацией покупателя в магазине) *}
...
<table cellspacing="0" cellpadding="0" width="100%">
  <tr>
    <td class="cbt" align="left"><strong>{$smarty.const.STRING_ORDER_CONFIRMATION}</strong></td>
  </tr>
</table>
{if $order_success}
