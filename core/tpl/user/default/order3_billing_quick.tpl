{* шаблон формы выбора способа оплаты (без регистрации покупателя в магазине) *}
...
<table cellspacing="0" cellpadding="0" width="100%">
  <tr>
    <td class="hmin" align="left"><form name='MainForm' method="POST" action="" id="MainForm">
      ...
      <tr>
          <td class="pad" align="center" valign="middle"><input type="radio" name="select_payment_method" id="select_payment_method_{$smarty.section.i.index}" value="{$payment_methods[i].PID}" {if $payment_methods_count == 1} checked{/if}></td>
...
<table cellspacing="0" cellpadding="0" width="100%">
  <tr>
    <td class="hdbot"><a href="#" onclick="select_payment_methodClickHandler(); return false;">{$smarty.const.CONTINUE_BUTTON}</a></td>
  </tr>
</table>
