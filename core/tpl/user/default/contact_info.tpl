{* шаблон формы изменения контактных данных *}

{include file="header.tpl" header=$smarty.const.STRING_USER_DATA_ALL}
          ...
          <tr>
            <td align="center">{$smarty.const.STRING_REQUIRED}<br>
              ...
              <table cellspacing="0" cellpadding="0" align="center">
                ...
                <tr>
                  <td></td>
                  <td align="left"><br><a href="#" onclick="document.getElementById('formcont').submit(); return false">{$smarty.const.SAVE_BUTTON}</a><input type=hidden value="" name="save"></td>
                </tr>
              </table></td>
          </tr>
        </table>
