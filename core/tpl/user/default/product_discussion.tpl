{* шаблон обсуждений товаров *}

{include file="header.tpl" header="`$smarty.const.DISCUSSION_TITLE`: `$product_name`"}
<table cellspacing="0" cellpadding="0" width="100%">
  <tr>
    <td class="cbt" align="left"><a href="index.php?productID={$productID}">{$smarty.const.DISCUSSION_GO_BACKLINK}</a></td>
  </tr>
</table>
<table cellspacing="0" cellpadding="0" width="100%">
  <tr>
...
{include file="header.tpl" header=$smarty.const.DISCUSSION_ADD_MESSAGE}
<table cellspacing="0" cellpadding="0" width="100%">
  <tr>
