...
<table border="0" cellspacing="4">
        ...
        <tr>
                <td><div align="left" style="padding-bottom: 2px;">{$smarty.const.ADMIN_CUSTOMER_LOGIN}</div><input type="text" name="login" value='{$login}' class="prc" size="25"></td>
        </tr>

        <tr>
                <td><div align="left" style="padding-bottom: 2px;">{$smarty.const.ADMIN_CUSTOMER_FIRST_NAME}</div><input type="text" name="first_name" value='{$first_name}' class="prc" size="25"></td>
        </tr>

        <tr>
                <td><div align="left" style="padding-bottom: 2px;">{$smarty.const.ADMIN_CUSTOMER_LAST_NAME}</div><input type="text" name="last_name" value='{$last_name}' class="prc" size="25"></td>
        </tr>

        <tr>
                <td><div align="left" style="padding-bottom: 2px;">{$smarty.const.ADMIN_CUSTOMER_EMAIL}</div><input type="text" name="email" value='{$email}' class="prc" size="25"></td>
        </tr>

        <tr>
                <td><div align="left" style="padding-bottom: 2px;">{$smarty.const.ADMIN_CUSTOMER_GROUP_NAME}</div><select name="groupID">
                  ...
                  <tr>
                <td><div align="left" style="padding-bottom: 2px;">{$smarty.const.STRING_MODULE_STATUS}</div>
...
<td>
<div class="dvmenu">
{$smarty.const.STRING_CALENDAR}<br>
{if $Error_DateFormat}<span style="color: red;">{$smarty.const.AFFP_MSG_ERROR_DATE_FORMAT}</span><br>{/if}
<form method="POST" action="{$REQUEST_URI}" id="leftsrform">
<table border="0" cellspacing="4">

        <tr>
                <td><div align="left" style="padding-bottom: 2px;">{$smarty.const.STRING_FROM}:</div><input type="text" name="from" value="{$from}" class="prc" size="25"></td>
        </tr>

        <tr>
                <td><div align="left" style="padding-bottom: 2px;">{$smarty.const.STRING_TILL}:</div><input name="till" value="{$till}" type="text" class="prc" size="25"></td>
        </tr>
                                   ...
                                   <td class="head2">
                                       <table class="adn">
                                           <tr>
                                             ...
                                             <td align="right"><div align="right"><a href='{$urlToCategoryTreeExpand}&amp;expandCatp=all' title="{$smarty.const.ADMIN_ADMIN_MENUNEW2}" style="cursor: pointer;"><img src="data/admin/004.gif" alt=""></a></div></td>
                                             <td align="right" class="head7"><div align="right"><a href='{$urlToCategoryTreeExpand}&amp;shrinkCatm=all' title="{$smarty.const.ADMIN_ADMIN_MENUNEW3}" style="cursor: pointer;"><img src="data/admin/003.gif" alt=""></a></div></td>
...
<td align="left" width="16" valign="middle"><input type=radio class="round" name=order_search_type id=order_search_type1 value='SearchByOrderID'
                                ...
                                ></td>
                                <td valign="middle" height="20">{$smarty.const.ADMIN_ORDER_SEARCH_BY_NUMBER}</td></tr>
                                <tr><td>&nbsp;</td><td align="left"><input type=text name='orderID_textbox' id='orderID_textbox' value='{$orderID}' class="prc" size="21"></td>
...
{if $order_search_type == 'SearchByStatusID'} checked {/if} onclick='order_search_typeClickHandler()'></td>
<td valign="middle">&nbsp;{$smarty.const.ADMIN_SHOW_ORDER_IN_STATUS}</td></tr>
...
{section name=i loop=$order_statuses}
<tr>
<td height="18" width="16"><input type=checkbox class="round" name=checkbox_order_status_{$order_statuses[i].statusID}  id=checkbox_order_status_{$order_statuses[i].statusID}
{if $order_statuses[i].selected == 1} checked {/if} value='1'>
</td>
<td align="left" nowrap="nowrap" valign="middle">&nbsp;{$order_statuses[i].status_name}</td></tr>
{/section}
</table>
{/if}
<script type="text/javascript">
...
<input type=hidden name="search"></div></td>
                               ...
                               <tr>
<td>
<div class="dvmenu"> <div align="center" style="padding-bottom: 5px;">{$smarty.const.STRING_ORD_DEL2}:</div><div align="center"><form method=GET action="{$smarty.const.ADMIN_FILE}" name="delordform" id="delordform"><select name="status_del">
                               {section name=i loop=$order_statuses}
...
<table class="adn"><tr><td height="8"></td></tr></table>
<div align="center"><img src="data/admin/delkn.gif" alt="" onclick="confirmDeletef('delordform','{$smarty.const.QUESTION_DELETE_CONFIRMATION_ZAK}'); return false" style="cursor: pointer"></div></div></td>
                               </tr>
                               <tr>
                                   <td class="se"></td>
                               </tr>
...
<table class="adn">
 <tr>
   <td class="l1"><img src="data/admin/dr.gif" alt=""></td>
   <td class="l2"><a href="{$url_allcategories}">{$smarty.const.ADMIN_LE_ALL_CATEGORIES}</a></td>
...
<table class="adn"><tr>
<td class="l1"><img src="data/admin/dr.gif" alt=""></td>
<td class="l2"><a href="{"msg=&page=1&show_all=&categoryID=`$le_categories[i].le_cID`"|set_query}">{$le_categories[i].le_cName}</a></td>
<td class="l3"><a href="#" onclick="show_rencat_block('{$le_categories[i].le_cID}', '{$le_categories[i].le_cName|replace:"\\":"\\\\"|replace:"&#039;":"\'"}');">{$le_categories[i].links_num}</a></td>
</tr>
</table>
{/section}
</div></td></tr>
...
<td>
<div class="dvmenu">
<table class="adn"><tr><td><img src="data/admin/drs.gif" alt=""></td><td width="100%"><a href="{$smarty.const.ADMIN_FILE}?dpt=catalog&amp;sub=products_categories">{$smarty.const.ADMIN_CATEGORIES_PRODUCTS}</a></td></tr></table>
<table class="adn topj"><tr><td><img src="data/admin/drs.gif" alt=""></td><td width="100%"><a href="{$smarty.const.ADMIN_FILE}?dpt=catalog&amp;sub=dbsync">{$smarty.const.ADMIN_SYNCHRONIZE_TOOLS}</a></td></tr></table>
<table class="adn topj"><tr><td><img src="data/admin/drs.gif" alt=""></td><td width="100%"><a href="{$smarty.const.ADMIN_FILE}?dpt=catalog&amp;sub=extra">{$smarty.const.ADMIN_PRODUCT_OPTIONS}</a></td></tr></table>
<table class="adn topj"><tr><td><img src="data/admin/drs.gif" alt=""></td><td width="100%"><a href="{$smarty.const.ADMIN_FILE}?dpt=catalog&amp;sub=special">{$smarty.const.ADMIN_SPECIAL_OFFERS}</a></td></tr></table>
<table class="adn topj"><tr><td><img src="data/admin/drs.gif" alt=""></td><td width="100%"><a href="{$smarty.const.ADMIN_FILE}?dpt=catalog&amp;sub=excel_import">{$smarty.const.ADMIN_IMPORT_FROM_EXCEL}</a></td></tr></table>
<table class="adn topj"><tr><td><img src="data/admin/drs.gif" alt=""></td><td width="100%"><a href="{$smarty.const.ADMIN_FILE}?dpt=catalog&amp;sub=excel_export">{$smarty.const.ADMIN_EXPORT_TO_EXCEL}</a></td></tr></table>
</div></td>
                               </tr>
                               <tr>
                                   <td class="se"></td>
...
<td>
<div class="dvmenu">
<table class="adn"><tr><td><img src="data/admin/drs.gif" alt=""></td><td width="100%"><a href="{$smarty.const.ADMIN_FILE}?dpt=custord&amp;sub=new_orders">{$smarty.const.ADMIN_NEW_ORDERS}</a></td></tr></table>
<table class="adn topj"><tr><td><img src="data/admin/drs.gif" alt=""></td><td width="100%"><a href="{$smarty.const.ADMIN_FILE}?dpt=custord&amp;sub=subscribers">{$smarty.const.ADMIN_NEWS_SUBSCRIBERS}</a></td></tr></table>
<table class="adn topj"><tr><td><img src="data/admin/drs.gif" alt=""></td><td width="100%"><a href="{$smarty.const.ADMIN_FILE}?dpt=custord&amp;sub=order_statuses">{$smarty.const.ADMIN_ORDER_STATUES}</a></td></tr></table>
<table class="adn topj"><tr><td><img src="data/admin/drs.gif" alt=""></td><td width="100%"><a href="{$smarty.const.ADMIN_FILE}?dpt=custord&amp;sub=reg_fields">{$smarty.const.ADMIN_CUSTOMER_REG_FIELDS}</a></td></tr></table>
<table class="adn topj"><tr><td><img src="data/admin/drs.gif" alt=""></td><td width="100%"><a href="{$smarty.const.ADMIN_FILE}?dpt=custord&amp;sub=discounts">{$smarty.const.ADMIN_DISCOUNT_MENU}</a></td></tr></table>
<table class="adn topj"><tr><td><img src="data/admin/drs.gif" alt=""></td><td width="100%"><a href="{$smarty.const.ADMIN_FILE}?dpt=custord&amp;sub=aux_pages">{$smarty.const.ADMIN_TX7}</a></td></tr></table>
</div></td>
                               </tr>
                               <tr>
                                   <td class="se"></td>
...
<td>
<div class="dvmenu">
<table class="adn"><tr><td><img src="data/admin/drs.gif" alt=""></td><td width="100%"><a href="{$smarty.const.ADMIN_FILE}?dpt=conf&amp;sub=setting&amp;settings_groupID=2">{$smarty.const.ADMIN_SETTINGS_GENERAL}</a></td></tr></table>
<table class="adn topj"><tr><td><img src="data/admin/drs.gif" alt=""></td><td width="100%"><a href="{$smarty.const.ADMIN_FILE}?dpt=conf&amp;sub=currencies">{$smarty.const.ADMIN_CURRENCY_TYPES}</a></td></tr></table>
<table class="adn topj"><tr><td><img src="data/admin/drs.gif" alt=""></td><td width="100%"><a href="{$smarty.const.ADMIN_FILE}?dpt=conf&amp;sub=shipping">{$smarty.const.ADMIN_STRING_SHIPPING_TYPE}</a></td></tr></table>
<table class="adn topj"><tr><td><img src="data/admin/drs.gif" alt=""></td><td width="100%"><a href="{$smarty.const.ADMIN_FILE}?dpt=conf&amp;sub=payment">{$smarty.const.ADMIN_STRING_PAYMENT_TYPE}</a></td></tr></table>
<table class="adn topj"><tr><td><img src="data/admin/drs.gif" alt=""></td><td width="100%"><a href="{$smarty.const.ADMIN_FILE}?dpt=conf&amp;sub=blocks_edit">{$smarty.const.ADMIN_TX20}</a></td></tr></table>
<table class="adn topj"><tr><td><img src="data/admin/drs.gif" alt=""></td><td width="100%"><a href="{$smarty.const.ADMIN_FILE}?dpt=conf&amp;sub=admin_edit">{$smarty.const.ADMIN_CONF_ADMINS}</a></td></tr></table>
</div></td>
                               </tr>
                               <tr>
                                   <td class="se"></td>
...
<table class="adn topj"><tr><td><img src="data/admin/drs.gif" alt=""></td><td width="100%"><a href="{$smarty.const.ADMIN_FILE}?dpt=modules&amp;sub=survey">{$smarty.const.ADMIN_VOTING}</a></td></tr></table>
<table class="adn topj"><tr><td><img src="data/admin/drs.gif" alt=""></td><td width="100%"><a href="{$smarty.const.ADMIN_FILE}?dpt=modules&amp;sub=shipping">{$smarty.const.ADMIN_STRING_SHIPPING_MODULES}</a></td></tr></table>
<table class="adn topj"><tr><td><img src="data/admin/drs.gif" alt=""></td><td width="100%"><a href="{$smarty.const.ADMIN_FILE}?dpt=modules&amp;sub=payment">{$smarty.const.ADMIN_STRING_PAYMENT_MODULES}</a></td></tr></table>
<table class="adn topj"><tr><td><img src="data/admin/drs.gif" alt=""></td><td width="100%"><a href="{$smarty.const.ADMIN_FILE}?dpt=modules&amp;sub=linkexchange">{$smarty.const.ADMIN_STRING_MODULES_LINKEXCHANGE}</a></td></tr></table>
...
<table class="adn topj"><tr><td><img src="data/admin/drs.gif" alt=""></td><td width="100%"><a href="{$smarty.const.ADMIN_FILE}?dpt=modules&amp;sub=url_rewriter">{$smarty.const.HFU_MODULE}</a></td></tr></table>
</div></td>
                               </tr>
                               <tr>
                                   <td class="se"></td>
...
<td>
<div class="dvmenu">
<table class="adn"><tr><td><img src="data/admin/drs.gif" alt=""></td><td width="100%"><a href="{$smarty.const.ADMIN_FILE}?dpt=reports&amp;sub=category_viewed_times">{$smarty.const.ADMIN_CATEGORY_VIEWED_TIMES}</a></td></tr></table>
<table class="adn topj"><tr><td><img src="data/admin/drs.gif" alt=""></td><td width="100%"><a href="{$smarty.const.ADMIN_FILE}?dpt=reports&amp;sub=customer_log">{$smarty.const.ADMIN_CUSTOMER_LOG}</a></td></tr></table>
<table class="adn topj"><tr><td><img src="data/admin/drs.gif" alt=""></td><td width="100%"><a href="{$smarty.const.ADMIN_FILE}?dpt=reports&amp;sub=information">{$smarty.const.ADMIN_INFORMATION2}</a></td></tr></table>
<table class="adn topj"><tr><td><img src="data/admin/drs.gif" alt=""></td><td width="100%"><a href="{$smarty.const.ADMIN_FILE}?dpt=reports&amp;sub=coming">{$smarty.const.ADMIN_COMING}</a></td></tr></table>
<table class="adn topj"><tr><td><img src="data/admin/drs.gif" alt=""></td><td width="100%"><a href="{$smarty.const.ADMIN_FILE}?dpt=reports&amp;sub=security">{$smarty.const.ADMIN_SECURITY}</a></td></tr></table>
</div></td>
                                   </tr>                               <tr>
                                   <td class="se"></td>
                               </tr>  <tr>
...
<td>
<div class="dvmenu">
<table class="adn"><tr><td><img src="data/admin/drs.gif" alt=""></td><td width="100%"><a href="{$smarty.const.ADMIN_FILE}?login=&amp;first_name=&amp;last_name=&amp;email=&amp;groupID=0&amp;fActState=-1&amp;dpt=custord&amp;sub=custlist&amp;search=Find">{$smarty.const.ADMIN_CUSTOMERS}</a></td></tr></table>
<table class="adn topj"><tr><td><img src="data/admin/drs.gif" alt=""></td><td width="100%"><a href="{$smarty.const.ADMIN_FILE}?dpt=custord&amp;sub=custgroup">{$smarty.const.ADMIN_CUSTGROUP}</a></td></tr></table>
<table class="adn topj"><tr><td><img src="data/admin/drs.gif" alt=""></td><td width="100%"><a href="{$smarty.const.ADMIN_FILE}?dpt=conf&amp;sub=countries">{$smarty.const.ADMIN_MENU_TOWNS}</a></td></tr></table>
<table class="adn topj"><tr><td><img src="data/admin/drs.gif" alt=""></td><td width="100%"><a href="{$smarty.const.ADMIN_FILE}?dpt=conf&amp;sub=zones">{$smarty.const.ADMIN_MENU_TAXEZ}</a></td></tr></table>
<table class="adn topj"><tr><td><img src="data/admin/drs.gif" alt=""></td><td width="100%"><a href="{$smarty.const.ADMIN_FILE}?dpt=catalog&amp;sub=discuss">{$smarty.const.ADMIN_DISCUSSIONS}</a></td></tr></table>
</div></td>
                                   </tr>
                               </table>
{literal}
