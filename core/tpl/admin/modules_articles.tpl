...
<p>Модуль <strong>"Статьи"</strong>.</p>
<p>Разработка и техническая поддержка модуля - <u><a href="http://shopcms-moduli.com/contacts.html?from=shopcmsAdmModArticles" target="_blank" title="Внешняя ссылка, откроется в новом окне">http://shopcms-moduli.com/contacts.html</a></u></p>
</div></td>
        </tr>
      </table>
